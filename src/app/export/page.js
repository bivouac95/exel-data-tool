  ...
  return (
    <div className="col-start-2 md:col-start-3 lg:col-start-3 col-span-3 md:col-span-4 lg:col-span-5 flex flex-col gap-10">
      ...
      <Button
        ...
        size="lg"
      >
        <img className="w-5 h-5" src="/download.svg" alt="export" />
        <span className="regular">Экспортировать</span>
      </Button>
      <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-5">
        <div
          className={`flex flex-col justify-between box-border p-5 bg-gray rounded-d h-72 border-green ${
        ...
        >
          ...
          {!isSelected ? (
            ...
            <Button
              className="w-full regular bg-green"
              variant="secondary"
              size="lg"
              onClick={() => setIsSelected(!isSelected)}
            >
